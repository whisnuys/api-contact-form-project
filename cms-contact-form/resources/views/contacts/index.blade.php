...
@section('content')
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route('contacts.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add
            Contact</a>
    </div>
                    ...
                    <tr class="text-center border-t hover:bg-gray-50">
                        ...
                        <td class="py-2 px-4 flex justify-center space-x-2">
                            ...
                            <form action="{{ route('contacts.destroy', $contact['id']) }}" method="POST"
                                onsubmit="return confirm('Are you sure to delete this contact?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
