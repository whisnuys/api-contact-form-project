...
@section('content')
    ...
    <form action="{{ route('contacts.store') }}" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded shadow-md"
        ...
        <div class="mb-4">
            ...
            <textarea name="message"
                class="w-full h-32 resize-y border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
